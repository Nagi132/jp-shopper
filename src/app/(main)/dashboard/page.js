    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-gray-900">{myRequests.length}</span>
              </div>
            </div>
          </CardContent>
          <CardFooter>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Requests you can accept</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col justify-center items-center h-32 text-center">
              <p className="text-3xl font-bold">{openRequests.length}</p>
              <p className="text-gray-500">Open {openRequests.length === 1 ? 'Request' : 'Requests'}</p>
              <Link href="/requests?filter=open" className="text-blue-500 hover:underline mt-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Recent shopping requests you can fulfill</CardDescription>
        </CardHeader>
        <CardContent>
          {openRequests.length === 0 ? (
            ...
            <div className="space-y-4">
              ...
              {openRequests.length > 5 && (
                <div className="text-center pt-2">
                  <Link href="/requests?filter=open" className="text-sm text-blue-500 hover:underline">
      ...
      {myRequests.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle>Your Current Jobs</CardTitle>
