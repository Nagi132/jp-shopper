  ...
  useEffect(() => {
    const fetchRequest = async () => {
      try {
        ...
        // Get the user's profile to check shopper status
        ...
        console.log('Request shopper_id:', data.shopper_id);
        console.log('User shopper profile id:', profile?.shopper_profiles?.id);
